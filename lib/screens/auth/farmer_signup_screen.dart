...
class _FarmerSignUpScreenState extends State<FarmerSignUpScreen> {
  ...
  Future<void> _signUp() async {
    ...
    if (_selectedFarmAddress == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Please select your farm address'),
        ...
        try {
          ...
          await _authService.createUserProfile(
            ...
            additionalData: {
              ...
              'address': _selectedFarmAddress!.address,
              'latitude': _selectedFarmAddress!.latitude,
              'longitude': _selectedFarmAddress!.longitude,
              'placeId': _selectedFarmAddress!.placeId,
              'farmAddress': _selectedFarmAddress!.address, // Legacy field
              'farmLatitude': _selectedFarmAddress!.latitude,
              'farmLongitude': _selectedFarmAddress!.longitude,
              'farmPlaceId': _selectedFarmAddress!.placeId,
            },
          );
          ...
          if (mounted) {
            ...
            // Still navigate to main screen - they can complete profile later
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (context) => const FarmerMainScreen(),
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Sell your imperfect produce and reduce waste',
                    style: TextStyle(
                      fontSize: 16,

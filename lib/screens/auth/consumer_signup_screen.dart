  ...
  Future<void> _signUp() async {
    ...
    try {
      ...
      if (userCredential?.user != null && mounted) {
        try {
          print('Creating consumer profile for: ${userCredential!.user!.uid}'); // Debug log
          ...
          print('Consumer profile created successfully'); // Debug log

          // Navigate to consumer main screen
          if (mounted) {
            print('Navigating to ConsumerMainScreen'); // Debug log
          ...
          print('Profile creation error: $profileError'); // Debug log
          ...
          if (mounted) {
            ...
            print('Navigating to ConsumerMainScreen after profile error'); // Debug log
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (context) => const ConsumerMainScreen(),
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Buy fresh imperfect produce at great prices',
                    style: TextStyle(
                      fontSize: 16,
